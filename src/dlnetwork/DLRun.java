...
public class DLRun {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException{
        ...
        DLInit.InitType initType = DLInit.InitType.RANDOM; // RANDOM, LOAD_PRE_SAVED, LOAD_BEST
        DLInit.saveRand = true;     // If creating new weights/biases, save for future comparations
